...
import com.netmind.common.threads.StudentThreadJSON;
import com.netmind.common.threads.StudentThreadTXT;
...
public class StudentConsole {
	...
	public static void selectOperation() {
		...
		// StudentThreadJSON stj = new StudentThreadJSON();
		...
		do {
			...
			case ADD_STUDENT:
				...
				StudentThreadTXT stt = new StudentThreadTXT(student);
				StudentThreadJSON stj = new StudentThreadJSON(student);
				stt.start();
				stj.start();
				/*
				 * try { //studentBl.add(student);
